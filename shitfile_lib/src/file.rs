...
/// A struct representing an actual shitfile.
/// ```
/// use shitfile_lib::file::SHITFILE;
/// let file = SHITFILE::new(20, 20);
/// ```
pub struct SHITFILE {
    chunks: Vec<Chunk>,
    bytes: Vec<u8>,
...
impl SHITFILE {
    ...
    // Magic bytes spelling "SHITFILE" with some filler text
    pub const MAGIC_BYTES: [u8; 10] = [83, 72, 73, 84, 70, 73, 76, 69, 00, 00];

    /// Create a new empty shitfile
    pub fn new(x: usize, y: usize) -> SHITFILE {
    ...
    /// Attemps to construct a SHITFILE given a stream of chunks along with some dimensions
...
impl TryFrom<Vec<u8>> for SHITFILE {
...
mod file_tests {
    ...
    #[test]
    fn push_chunk() {
        let mut file = SHITFILE::new(20, 20);
    ...
    fn as_bytes() {
        ...
        assert_eq!(
            file.as_bytes(),
            [
                83, 72, 73, 84, 70, 73, 76, 69, 0, 0, 0, 0, 0, 0, 0, 0, 0, 20, 0, 0, 0, 0, 0, 0, 0,
    ...
    fn test_from_bytes_invalid_header() {
        ...
        let file = SHITFILE::try_from(bytes);
    ...
    fn test_from_bytes_invalid_chunk() {
        let bytes = vec![
            83, 72, 73, 84, 70, 73, 76, 69, 0, 0, 0, 0, 0, 0, 0, 0, 0, 20, 0, 0, 0, 0, 0, 0, 0, 20,
    ...
    fn test_from_bytes_successfully() {
        let bytes = vec![
            83, 72, 73, 84, 70, 73, 76, 69, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 2,
    ...
    fn test_from_chunks_invalid_dimensions() {
        ...
        let file = SHITFILE::try_from_chunks(20, 20, chunks);
    ...
    fn test_from_chunks_successfully() {
        ...
        let file = SHITFILE::try_from_chunks(2, 2, chunks);
